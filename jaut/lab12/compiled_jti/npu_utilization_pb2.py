...
NetworkProcessorUtilization = _reflection.GeneratedProtocolMessageType('NetworkProcessorUtilization', (_message.Message,), dict(
...
MemoryLoad = _reflection.GeneratedProtocolMessageType('MemoryLoad', (_message.Message,), dict(
...
PacketLoad = _reflection.GeneratedProtocolMessageType('PacketLoad', (_message.Message,), dict(
