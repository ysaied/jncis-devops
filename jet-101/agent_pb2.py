...
_KEYVALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='float_value', full_name='telemetry.KeyValue.float_value', index=8,
...
_KEYVALUE.oneofs_by_name['value'].fields.append(
  _KEYVALUE.fields_by_name['float_value'])
_KEYVALUE.fields_by_name['float_value'].containing_oneof = _KEYVALUE.oneofs_by_name['value']
